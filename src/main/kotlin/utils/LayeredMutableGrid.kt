...
class LayeredMutableGrid<T> private constructor(private val baseGrid: BaseGrid<T>) : MutableGrid<T> {
    ...
    override fun get(x: Int, y: Int) = get(Position(x, y))
    override fun set(x: Int, y: Int, value: T) = set(Position(x, y), value)

    private fun get(position: Position) = baseGrid[transformations.untransformPosition(position, dimensions())]

    private fun set(position: Position, value: T) {
    ...
    override fun numCols() = dimensions().x

    override fun numRows() = dimensions().y
    ...
    companion object {
        ...
        fun of(input: String): LayeredMutableGrid<Char> {
            ...
            return LayeredMutableGrid(BaseGrid((0..<numCols).map { numCol ->
